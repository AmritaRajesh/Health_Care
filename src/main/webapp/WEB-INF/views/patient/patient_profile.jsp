...
<head>
<meta charset="UTF-8">
<title>Patient Profile - Hospital Management</title>
...
<jsp:include page="sidebar.jsp" />
        ...
        <div class="row g-4 mt-2">
                    ...
                    <form action="${pageContext.request.contextPath}/patient/profile" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" value="${patient.email}" readonly style="background:#f1f5f9; cursor:not-allowed;">
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="profile-card">
                    <h3 class="card-header-title">Security</h3>
                    <form action="${pageContext.request.contextPath}/patient/profile" method="post">
