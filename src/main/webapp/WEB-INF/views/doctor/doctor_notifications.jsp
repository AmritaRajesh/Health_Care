...
<style>
.notif-item { background: white; border: 1px solid #e2e8f0; border-radius: 10px; padding: 16px 20px; margin-bottom: 12px; display: flex; align-items: flex-start; gap: 14px; transition: 0.2s; }
...
<jsp:include page="sidebar.jsp" />
    ...
    <p class="page-subtitle">Alerts for appointments, prescriptions, and updates</p>
